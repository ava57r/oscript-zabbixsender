...
Результат = Отправлятор.ОтправитьОдноЗначение(""host1"", ""key1"", ""руссо туристо"");
...
"
		...
		public static HostedScriptEngine StartEngine()
		{
			...
			engine.AttachAssembly(System.Reflection.Assembly.GetAssembly(typeof(OneScript.Zabbix.Sender)));
